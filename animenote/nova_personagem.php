...
?>
		<title>Nova personagem - <?php echo $nome_website; ?></title>
	...
	<body>
		...
		<!-- Wrapper -->
			<div class="wrapper style1">
				...
				<!-- Page -->
					<form name="EditAnime" method="post" action="nova_personagem_script" enctype="multipart/form-data">
					<div id="page" class="container">
						<div class="row">
							...
							<div id="sidebar" class="4u">
								...
								<section><br>
										<li>🔧 <a onclick="$(this).closest('form').submit()">Adicionar nova personagem</a></li>
									<header class="major">
										<br>
										<h1>Informação</h1>
									</header>
							...
							<div id="content" class="8u skel-cell-important">
								<section>
									<header class="major">
										<div class="titulo"><div class="dados h2-dados"><input type = 'text' name='nome' placeholder="Nome" required></div></div>
									</header>
									<h3>Biografia:</h3>
									<div class="dados h2-dados"><textarea name='biografia' placeholder="Biografia..." required></textarea></div>
								</section>
							</div>
